...
class Config:
    ...
    TG_BOT_TOKEN = get_config("1456031638:AAEHjOeROrmCeF0pKK0gt6XHPnNNmtLFePU", should_prompt=True)
    # The Telegram API things
    APP_ID = int(get_config("1366324", should_prompt=True))
    API_HASH = get_config("0d0274833b354d9223ca60b3e2f1e7c8", should_prompt=True)
